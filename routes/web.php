...
Route::prefix('frenchise')->group(function() {
  ...
  Route::get('/orders', 'App\Http\Controllers\AdminOrderController@index')->name('admin-order-index');
  Route::get('/orders/pending', 'App\Http\Controllers\AdminOrderController@pending')->name('admin-order-pending');
  Route::get('/orders/processing', 'App\Http\Controllers\AdminOrderController@processing')->name('admin-order-processing');
  Route::get('/orders/completed', 'App\Http\Controllers\AdminOrderController@completed')->name('admin-order-completed');
  Route::get('/orders/declined', 'App\Http\Controllers\AdminOrderController@declined')->name('admin-order-declined');
  Route::get('/order/{id}/show', 'App\Http\Controllers\AdminOrderController@show')->name('admin-order-show');
  Route::get('/order/{id}/invoice', 'App\Http\Controllers\AdminOrderController@invoice')->name('admin-order-invoice');
  Route::get('/order/{id}/print', 'App\Http\Controllers\AdminOrderController@printpage')->name('admin-order-print');
  Route::get('/order/{id1}/status/{status}', 'App\Http\Controllers\AdminOrderController@status')->name('admin-order-status');
  Route::post('/order/email/', 'App\Http\Controllers\AdminOrderController@emailsub')->name('admin-order-emailsub');
  Route::post('/order/{id}/license', 'App\Http\Controllers\AdminOrderController@license')->name('admin-order-license');

  Route::get('/users', 'App\Http\Controllers\AdminUserController@index')->name('admin-user-index'); 
  Route::get('/users/edit/{id}', 'App\Http\Controllers\AdminUserController@edit')->name('admin-user-edit');
  Route::post('/users/edit/{id}', 'App\Http\Controllers\AdminUserController@update')->name('admin-user-update');
  Route::get('/users/delete/{id}', 'App\Http\Controllers\AdminUserController@destroy')->name('admin-user-delete');
  Route::get('/user/{id}/show', 'App\Http\Controllers\AdminUserController@show')->name('admin-user-show');

  Route::get('/product', 'App\Http\Controllers\ProductController@index')->name('admin-prod-index');

  Route::get('/product/deactive', 'App\Http\Controllers\ProductController@deactive')->name('admin-prod-deactive');
  Route::get('/product/create', 'App\Http\Controllers\ProductController@create')->name('admin-prod-create');
  Route::post('/product/create', 'App\Http\Controllers\ProductController@store')->name('admin-prod-store');
  Route::post('/product/create1', 'App\Http\Controllers\ProductController@store1')->name('admin-prod-store1');
  Route::post('/product/create2', 'App\Http\Controllers\ProductController@store2')->name('admin-prod-store2');
  Route::get('/product/edit/{id}', 'App\Http\Controllers\ProductController@edit')->name('admin-prod-edit');
  Route::post('/product/update/{id}', 'App\Http\Controllers\ProductController@update')->name('admin-prod-update');
  Route::post('/product/update1/{id}', 'App\Http\Controllers\ProductController@update1')->name('admin-prod-update1');
  Route::post('/product/update2/{id}', 'App\Http\Controllers\ProductController@update2')->name('admin-prod-update2');
  Route::post('/product/feature/{id}', 'App\Http\Controllers\ProductController@feature')->name('admin-prod-feature');
  Route::post('/vendor/feature/{id}', 'App\Http\Controllers\ProductController@vendor_feature')->name('admin-vendor-feature');
  Route::get('/product/delete/{id}', 'App\Http\Controllers\ProductController@destroy')->name('admin-prod-delete');
  Route::get('/product/status/{id1}/{id2}', 'App\Http\Controllers\ProductController@status')->name('admin-prod-st');

  Route::get('/category', 'App\Http\Controllers\CategoryController@index')->name('admin-cat-index');
  Route::get('/category/create', 'App\Http\Controllers\CategoryController@create')->name('admin-cat-create');
  Route::post('/category/create', 'App\Http\Controllers\CategoryController@store')->name('admin-cat-store');
  Route::get('/category/edit/{id}', 'App\Http\Controllers\CategoryController@edit')->name('admin-cat-edit');
  Route::get('/category/edit/{id}', 'App\Http\Controllers\CategoryController@edit')->name('admin-cat-edit');///////////zee
  Route::get('/category/type_edit', 'App\Http\Controllers\CategoryController@type_edit')->name('admin-cat-type_edit');///////////zee
  Route::post('/category/update/{id}', 'App\Http\Controllers\CategoryController@update')->name('admin-cat-update');
  Route::post('/category/type_update/{id}', 'App\Http\Controllers\CategoryController@type_update')->name('admin-cat-type_update');////zeee
  Route::get('/category/delete/{id}', 'App\Http\Controllers\CategoryController@destroy')->name('admin-cat-delete');
  Route::get('/category/status/{id1}/{id2}', 'App\Http\Controllers\CategoryController@status')->name('admin-cat-st');
  Route::get('/category/type/{id1}/{id2}', 'App\Http\Controllers\CategoryController@set_type')->name('admin-cat-tp');/////zee
 
  Route::get('/subcategory', 'App\Http\Controllers\SubcategoryController@index')->name('admin-subcat-index');
  Route::get('/subcategory/create', 'App\Http\Controllers\SubcategoryController@create')->name('admin-subcat-create');
  Route::post('/subcategory/create', 'App\Http\Controllers\SubcategoryController@store')->name('admin-subcat-store');
  Route::get('/subcategory/edit/{id}', 'App\Http\Controllers\SubcategoryController@edit')->name('admin-subcat-edit');
  Route::post('/subcategory/update/{id}', 'App\Http\Controllers\SubcategoryController@update')->name('admin-subcat-update');
  Route::get('/subcategory/delete/{id}', 'App\Http\Controllers\SubcategoryController@destroy')->name('admin-subcat-delete');
  Route::get('/subcategory/status/{id1}/{id2}', 'App\Http\Controllers\SubcategoryController@status')->name('admin-subcat-st');

  Route::get('/childcategory', 'App\Http\Controllers\ChildcategoryController@index')->name('admin-childcat-index');
  Route::get('/childcategory/create', 'App\Http\Controllers\ChildcategoryController@create')->name('admin-childcat-create');
  Route::post('/childcategory/create', 'App\Http\Controllers\ChildcategoryController@store')->name('admin-childcat-store');
  Route::get('/childcategory/edit/{id}', 'App\Http\Controllers\ChildcategoryController@edit')->name('admin-childcat-edit');
  Route::post('/childcategory/update/{id}', 'App\Http\Controllers\ChildcategoryController@update')->name('admin-childcat-update');
  Route::get('/childcategory/delete/{id}', 'App\Http\Controllers\ChildcategoryController@destroy')->name('admin-childcat-delete');
  Route::get('/childcategory/status/{id1}/{id2}', 'App\Http\Controllers\ChildcategoryController@status')->name('admin-childcat-st');

  Route::get('/coupon', 'App\Http\Controllers\AdminCouponController@index')->name('admin-cp-index');
  Route::get('/coupon/create', 'App\Http\Controllers\AdminCouponController@create')->name('admin-cp-create');
  Route::post('/coupon/create', 'App\Http\Controllers\AdminCouponController@store')->name('admin-cp-store');
  Route::get('/coupon/edit/{id}', 'App\Http\Controllers\AdminCouponController@edit')->name('admin-cp-edit');
  Route::post('/coupon/edit/{id}', 'App\Http\Controllers\AdminCouponController@update')->name('admin-cp-update');  
  Route::get('/coupon/delete/{id}', 'App\Http\Controllers\AdminCouponController@destroy')->name('admin-cp-delete'); 
  Route::get('/coupon/status/{id1}/{id2}', 'App\Http\Controllers\AdminCouponController@status')->name('admin-cp-st');

  Route::get('/blog', 'App\Http\Controllers\AdminBlogController@index')->name('admin-blog-index');
  Route::get('/blog/create', 'App\Http\Controllers\AdminBlogController@create')->name('admin-blog-create');
  Route::post('/blog/create', 'App\Http\Controllers\AdminBlogController@store')->name('admin-blog-store');
  Route::get('/blog/edit/{id}', 'App\Http\Controllers\AdminBlogController@edit')->name('admin-blog-edit');
  Route::post('/blog/edit/{id}', 'App\Http\Controllers\AdminBlogController@update')->name('admin-blog-update');  
  Route::get('/blog/delete/{id}', 'App\Http\Controllers\AdminBlogController@destroy')->name('admin-blog-delete'); 
  
  Route::get('/subscription', 'App\Http\Controllers\VendorSubscriptionController@index')->name('admin-subscription-index');
  Route::get('/subscription/create', 'App\Http\Controllers\VendorSubscriptionController@create')->name('admin-subscription-create');
  Route::post('/subscription/create', 'App\Http\Controllers\VendorSubscriptionController@store')->name('admin-subscription-store');
  Route::get('/subscription/edit/{id}', 'App\Http\Controllers\VendorSubscriptionController@edit')->name('admin-subscription-edit');
  Route::post('/subscription/edit/{id}', 'App\Http\Controllers\VendorSubscriptionController@update')->name('admin-subscription-update');  
  Route::get('/subscription/delete/{id}', 'App\Http\Controllers\VendorSubscriptionController@destroy')->name('admin-subscription-delete'); 

  Route::get('/bottom-banners', 'App\Http\Controllers\ImageController@index')->name('admin-img1-index');
  Route::get('/bottom-banner/create', 'App\Http\Controllers\ImageController@create')->name('admin-img1-create');
  Route::post('/bottom-banner/create', 'App\Http\Controllers\ImageController@store')->name('admin-img1-store');
  Route::get('/bottom-banner/edit/{id}', 'App\Http\Controllers\ImageController@edit')->name('admin-img1-edit');
  Route::post('/bottom-banner/edit/{id}', 'App\Http\Controllers\ImageController@update')->name('admin-img1-update');  
  Route::get('/bottom-banner/delete/{id}', 'App\Http\Controllers\ImageController@destroy')->name('admin-img1-delete');

  Route::get('/banner/top', 'App\Http\Controllers\BannerController@top')->name('admin-banner-top');
  Route::get('/banner/shop/{slug}', 'App\Http\Controllers\BannerController@shop')->name('admin-banner-shop');
  Route::post('/banner/top', 'App\Http\Controllers\BannerController@topup')->name('admin-banner-topup');
  Route::post('/banner/top1', 'App\Http\Controllers\BannerController@topup1')->name('admin-banner-topup1');
  Route::get('/banner/edit/{id}/{slug}', 'App\Http\Controllers\BannerController@edit')->name('admin-banner-edit');
  Route::post('/banner/update/{id}', 'App\Http\Controllers\BannerController@update')->name('admin-banner-update');
  Route::get('/banner/delete/{id}', 'App\Http\Controllers\BannerController@destroy')->name('admin-banner-delete');
  Route::get('/banner/bottom', 'App\Http\Controllers\BannerController@bottom')->name('admin-banner-bottom');
  Route::post('/banner/bottom', 'App\Http\Controllers\BannerController@bottomup')->name('admin-banner-bottomup');
  Route::get('/general-settings/countdown', 'App\Http\Controllers\GeneralSettingController@countdown')->name('admin-gs-countdown');
  Route::post('/general-settings/countdown', 'App\Http\Controllers\GeneralSettingController@countdownup')->name('admin-gs-countdownup');

  Route::get('/general-settings/fes-info', 'App\Http\Controllers\GeneralSettingController@fesinfo')->name('admin-gs-festival');
  Route::post('/general-settings/fes-info', 'App\Http\Controllers\GeneralSettingController@fesinfoup')->name('admin-gs-fesinfoup');


  Route::group(['middleware'=>'isAdmin'],function(){
   
  Route::get('/frenchise', 'App\Http\Controllers\AdminController@listFrenchise')->name('admin-frenchise-index');
  Route::get('/frenchise-dashboard/{id}', 'App\Http\Controllers\AdminController@dashboardFrenchise')->name('admin-frenchise-dashboard');
  Route::get('/add-frenchise', 'App\Http\Controllers\AdminController@addFrenchise')->name('admin-frenchise-add');
  Route::post('/save-frenchise', 'App\Http\Controllers\AdminVendorController@storeFrenchise')->name('admin-frenchise-submit');
  Route::get('/frenchises/{id}/show', 'App\Http\Controllers\AdminController@show')->name('admin-frenchise-show');
  Route::get('/frenchises/status/{id1}/{id2}', 'App\Http\Controllers\AdminController@status')->name('admin-frenchise-st');
  Route::get('/frenchise/edit/{id}', 'App\Http\Controllers\AdminController@edit')->name('admin-frenchise-edit');
  Route::post('/frenchise/edit/{id}', 'App\Http\Controllers\AdminController@update')->name('admin-frenchise-update');
  Route::get('/frenchise/delete/{id}', 'App\Http\Controllers\AdminController@destroy')->name('admin-frenchise-delete');
  Route::get('/frenchise_asign/{id}/{id2}', 'App\Http\Controllers\AdminController@frenchiseAsign')->name('admin-frenchise-asign');

   Route::get('/vendors', 'App\Http\Controllers\AdminVendorController@index')->name('admin-vendor-index');
  Route::get('/vendors/subs', 'App\Http\Controllers\AdminVendorController@subs')->name('admin-vendor-subs');
  Route::get('/vendors/sub/{id}', 'App\Http\Controllers\AdminVendorController@sub')->name('admin-vendor-sub');
  Route::get('/vendors/{id}/show', 'App\Http\Controllers\AdminVendorController@show')->name('admin-vendor-show');
  Route::get('/vendor/edit/{id}', 'App\Http\Controllers\AdminVendorController@edit')->name('admin-vendor-edit');
  Route::post('/vendor/edit/{id}', 'App\Http\Controllers\AdminVendorController@update')->name('admin-vendor-update');
  Route::get('/vendors', 'App\Http\Controllers\AdminVendorController@index')->name('admin-vendor-index');
  Route::get('/vendors/pending', 'App\Http\Controllers\AdminVendorController@pending')->name('admin-vendor-pending');
  Route::get('/vendors/status/{id1}/{id2}', 'App\Http\Controllers\AdminVendorController@status')->name('admin-vendor-st');
  Route::get('/vendors/delete/{id}', 'App\Http\Controllers\AdminVendorController@destroy')->name('admin-vendor-delete');
  Route::get('/vendors/email/{id}', 'App\Http\Controllers\AdminVendorController@email')->name('admin-vendor-email');
  Route::get('/vendors/withdraws', 'App\Http\Controllers\AdminVendorController@withdraws')->name('admin-vendor-wt');
  Route::get('/vendors/withdraws/pending', 'App\Http\Controllers\AdminVendorController@pendings')->name('admin-wt-pending');
  Route::get('/vendors/withdraw/details/{id}', 'App\Http\Controllers\AdminVendorController@withdrawdetails')->name('admin-vendor-wtd');
  Route::get('/vendors/withdraw/accept/{id}', 'App\Http\Controllers\AdminVendorController@accept')->name('admin-wt-accept');
  Route::get('/vendors/withdraw/reject/{id}', 'App\Http\Controllers\AdminVendorController@reject')->name('admin-wt-reject');
  Route::get('/users/withdraws', 'App\Http\Controllers\AdminVendorController@userwithdraws')->name('admin-vendor-wtt');
  Route::get('/users/withdraws/pending', 'App\Http\Controllers\AdminVendorController@userpendings')->name('admin-wtt-pending');
  Route::get('/users/withdraw/details/{id}', 'App\Http\Controllers\AdminVendorController@userwithdrawdetails')->name('admin-vendor-wttd');
  Route::get('/users/withdraw/accept/{id}', 'App\Http\Controllers\AdminVendorController@useraccept')->name('admin-wtt-accept');
  Route::get('/users/withdraw/reject/{id}', 'App\Http\Controllers\AdminVendorController@userreject')->name('admin-wtt-reject');
    
  Route::get('/frenchise-product/{id}', 'App\Http\Controllers\AdminFrenchiseProductController@frenchiseProductIndex')->name('admin-frenchise-prod-index');
  Route::get('/frenchise/order/status/{status}/{id}', 'App\Http\Controllers\AdminFrenchiseProductController@frenchiseordersstatus')->name('admin-frenchise-order-status');
  Route::get('/frenchise/vender-list/{id}', 'App\Http\Controllers\AdminFrenchiseProductController@vendorlist')->name('admin-frenchise-vendor-list');

  Route::get('/frenchise-customer-list/{id}','App\Http\Controllers\AdminVendorController@customerlist')->name('admin-frenchise-vendor-customer'); 
  Route::get('/customer/{id}/show', 'App\Http\Controllers\AdminVendorController@customershow')->name('admin-frenchise-customer-show'); 
  
  Route::get('/frenchise-vendor-dashboard/{id}', 'App\Http\Controllers\AdminVendorController@vendorDashbord')->name('admin-frenchise-vendor-dashboard');
  Route::get('/vendors_active/status/{id1}/{id2}','App\Http\Controllers\AdminController@v_status')->name('admin-frenchise-vendor_active-status');
  Route::get('/vendor-product/{id}', 'App\Http\Controllers\AdminFrenchiseProductController@vendorProductIndex')->name('admin-frenchise-vendor-prod-index');
  Route::get('/vendor-product/deactive/{id}', 'App\Http\Controllers\AdminFrenchiseProductController@vendorProductDeactive')->name('admin-frenchise-vendor-prod-deactive'); 

  Route::get('/vendor-orders/{id}', 'App\Http\Controllers\AdminVendorController@vendororder')->name('admin-frenchise-vendor-order-index');
  Route::get('/vendor-orders/status/{id}/{status}', 'App\Http\Controllers\AdminVendorController@ordersstatus')->name('admin-frenchise-vendor-order-status');
  Route::get('/frenchise/order/{id}/invoice', 'App\Http\Controllers\AdminOrderController@invoice')->name('admin-frenchise-order-invoice');
  Route::get('/frenchise/order/{id}/show', 'App\Http\Controllers\AdminOrderController@show')->name('admin-frenchise-order-show');


  Route::get('/faq', 'App\Http\Controllers\FaqController@index')->name('admin-fq-index');
  Route::get('/faq/create', 'App\Http\Controllers\FaqController@create')->name('admin-fq-create');
  Route::post('/faq/create', 'App\Http\Controllers\FaqController@store')->name('admin-fq-store');
  Route::get('/faq/edit/{id}', 'App\Http\Controllers\FaqController@edit')->name('admin-fq-edit');
  Route::post('/faq/update/{id}', 'App\Http\Controllers\FaqController@update')->name('admin-fq-update');

  Route::get('/faq/delete/{id}', 'App\Http\Controllers\FaqController@destroy')->name('admin-fq-delete');


  Route::get('/currency', 'App\Http\Controllers\AdminCurrencyController@index')->name('admin-currency-index');
  Route::get('/currency/create', 'App\Http\Controllers\AdminCurrencyController@create')->name('admin-currency-create');
  Route::post('/currency/create', 'App\Http\Controllers\AdminCurrencyController@store')->name('admin-currency-store');
  Route::get('/currency/edit/{id}', 'App\Http\Controllers\AdminCurrencyController@edit')->name('admin-currency-edit');
  Route::post('/currency/update/{id}', 'App\Http\Controllers\AdminCurrencyController@update')->name('admin-currency-update');
  Route::get('/currency/delete/{id}', 'App\Http\Controllers\AdminCurrencyController@destroy')->name('admin-currency-delete');
  Route::get('/currency/status/{id1}/{id2}', 'App\Http\Controllers\AdminCurrencyController@status')->name('admin-currency-st');

  Route::get('/page', 'App\Http\Controllers\PageController@index')->name('admin-page-index');
  Route::get('/page/create', 'App\Http\Controllers\PageController@create')->name('admin-page-create');
  Route::post('/page/create', 'App\Http\Controllers\PageController@store')->name('admin-page-store');
  Route::get('/page/edit/{id}', 'App\Http\Controllers\PageController@edit')->name('admin-page-edit');
  Route::post('/page/update/{id}', 'App\Http\Controllers\PageController@update')->name('admin-page-update');
  Route::get('/page/delete/{id}', 'App\Http\Controllers\PageController@destroy')->name('admin-page-delete');


  Route::get('/paymentgateway', 'App\Http\Controllers\PaymentGatewayController@index')->name('admin-payment-index');
  Route::get('/paymentgateway/create', 'App\Http\Controllers\PaymentGatewayController@create')->name('admin-payment-create');
  Route::post('/paymentgateway/create', 'App\Http\Controllers\PaymentGatewayController@store')->name('admin-payment-store');
  Route::get('/paymentgateway/edit/{id}', 'App\Http\Controllers\PaymentGatewayController@edit')->name('admin-payment-edit');
  Route::post('/paymentgateway/update/{id}', 'App\Http\Controllers\PaymentGatewayController@update')->name('admin-payment-update');
  Route::get('/paymentgateway/delete/{id}', 'App\Http\Controllers\PaymentGatewayController@destroy')->name('admin-payment-delete');
  Route::get('/paymentgateway/st/{id1}/{id2}', 'App\Http\Controllers\PaymentGatewayController@status')->name('admin-payment-st');

  Route::get('/testimonial', 'App\Http\Controllers\PortfolioController@index')->name('admin-ad-index');
  Route::get('/testimonial/create', 'App\Http\Controllers\PortfolioController@create')->name('admin-ad-create');
  Route::post('/testimonial/create', 'App\Http\Controllers\PortfolioController@store')->name('admin-ad-store');
  Route::get('/testimonial/edit/{id}', 'App\Http\Controllers\PortfolioController@edit')->name('admin-ad-edit');
  Route::post('/testimonial/edit/{id}', 'App\Http\Controllers\PortfolioController@update')->name('admin-ad-update');  
  Route::get('/testimonial/delete/{id}', 'App\Http\Controllers\PortfolioController@destroy')->name('admin-ad-delete');

  Route::get('/services', 'App\Http\Controllers\AdminServiceController@index')->name('admin-service-index');
  Route::get('/services/create', 'App\Http\Controllers\AdminServiceController@create')->name('admin-service-create');
  Route::post('/services/create', 'App\Http\Controllers\AdminServiceController@store')->name('admin-service-store');
  Route::get('/services/edit/{id}', 'App\Http\Controllers\AdminServiceController@edit')->name('admin-service-edit');
  Route::post('/services/edit/{id}', 'App\Http\Controllers\AdminServiceController@update')->name('admin-service-update');  
  Route::get('/services/delete/{id}', 'App\Http\Controllers\AdminServiceController@destroy')->name('admin-service-delete');

  Route::get('/slider', 'App\Http\Controllers\SliderController@index')->name('admin-sl-index');
  Route::get('/slider/create', 'App\Http\Controllers\SliderController@create')->name('admin-sl-create');
  Route::post('/slider/create', 'App\Http\Controllers\SliderController@store')->name('admin-sl-store');
  Route::get('/slider/edit/{id}', 'App\Http\Controllers\SliderController@edit')->name('admin-sl-edit');
  Route::post('/slider/edit/{id}', 'App\Http\Controllers\SliderController@update')->name('admin-sl-update');  
  Route::get('/slider/delete/{id}', 'App\Http\Controllers\SliderController@destroy')->name('admin-sl-delete'); 
  ...
  // Route::get('/newupdate/slider/create', 'App\Http\Controllers\AdminController@slidercreate')->name('admin-newupdate-slider-create');
  // Route::post('/newupdate/slider/create', 'App\Http\Controllers\AdminController@sliderstore')->name('admin-newupdate-slider-store');
  // Route::get('/slider/edit/{id}', 'App\Http\Controllers\SliderController@edit')->name('admin-sl-edit');
  // Route::post('/slider/edit/{id}', 'App\Http\Controllers\SliderController@update')->name('admin-sl-update');  
  // Route::get('/slider/delete/{id}', 'App\Http\Controllers\SliderController@destroy')->name('admin-sl-delete');
