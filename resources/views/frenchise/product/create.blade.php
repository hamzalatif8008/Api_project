                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Add Product <a href="{{ route('frenchise-prod-index') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
...
<div>
    ...
    <div class="tab-content">
      <div class="tab-pane fade active in" id="physical">
                                        <form class="form-horizontal" action="{{route('frenchise-prod-store')}}" method="POST" enctype="multipart/form-data" id="form1">
                                          {{csrf_field()}}
                            ...
                            <div class="form-group">
                              ...
                              <br>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                              <input class="form-control" onkeypress="return isNumberKey(event)" name="cprice" id="blood_group_display_name" placeholder="e.g 20" required="" type="text">
                                            </div>
                                          </div>
                                          <div class="form-group">
                                            <label class="control-label col-sm-4" for="blood_group_display_name">Product Previous Price* <span>(Optional)</span></label>
                                            <div class="col-sm-6">
                                              <input class="form-control" onkeypress="return isNumberKey(event)" name="pprice" id="blood_group_display_name" placeholder="e.g 25"  type="text">
                                            </div>
                                          </div>
      ...
      <div class="tab-pane fade" id="digital">
                                        <form class="form-horizontal" action="{{route('frenchise-prod-store1')}}" method="POST" enctype="multipart/form-data"  id="form2">
      ...
      <div class="tab-pane fade" id="license">
                                        <form class="form-horizontal" action="{{route('frenchise-prod-store2')}}" method="POST" enctype="multipart/form-data"  id="form3">
