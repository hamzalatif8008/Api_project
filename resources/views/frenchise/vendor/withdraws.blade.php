                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Withdraws</h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Frenchise <i class="fa fa-angle-right" style="margin: 0 2px;"></i>Vendor <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Withdraws</p>
                                                </div>
                                            </div>
  ...
  <div class="col-sm-12">
                            ...
                            @foreach($withdraws as $withdraw)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('frenchise-vendor-wtd',$withdraw->id)}}" class="btn btn-primary product-btn"><i class="fa fa-eye"></i> View Details</a>
                                        @if($withdraw->status == "pending")
                                        <a href="javascript:;" data-href="{{route('frenchise-wt-accept',$withdraw->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-success product-btn"><i class="fa fa-send"></i> Accept</a>
                                        <a href="javascript:;" data-href="{{route('frenchise-wt-reject',$withdraw->id)}}" data-toggle="modal" data-target="#confirm-delete1" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Reject</a>
                                        @endif
                                    </td>
                                </tr>
                            @endforeach
