                    ...
                    <div class="row">
                                        ...
                                        <div class="row reorder-xs">
                                            <div class="col-lg-6 col-md-5 col-sm-5 col-xs-12">
                                                <div class="product-header-title">
                                                    <h2>Withdraw Details <a href="{{ route('frenchise-vendor-wtd') }}" style="padding: 5px 12px;" class="btn add-back-btn"><i class="fa fa-arrow-left"></i> Back</a></h2>
                                                    <p>Dashboard <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Frenchise <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Withdraws <i class="fa fa-angle-right" style="margin: 0 2px;"></i> Withdraw Details
                                                </div>
                                            </div>
                        ...
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('frenchise-vendor-show',$withdraw->user->id)}}" target="_blank">{{$withdraw->user->shop_name}}</a></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="30%" style="text-align: right;"><a href="javascript:;" data-href="{{route('frenchise-wt-accept',$withdraw->id)}}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-success product-btn"><i class="fa fa-send"></i> Accept</a></td>

                                <td><a href="javascript:;" data-href="{{route('frenchise-wt-reject',$withdraw->id)}}" data-toggle="modal" data-target="#confirm-delete1" class="btn btn-danger product-btn"><i class="fa fa-trash"></i> Reject</a></td>
                                @endif
                            </tr>
