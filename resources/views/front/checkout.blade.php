                     ...
                     <hr/>
                        ...
                        <form action="{{route('cash.submit')}}" method="post" id="payment_form">
                            ...
                            @else
                                ...
                                <div class="form-group">
                                    <label for="shippingFull_name">{{$lang->doph}}  <span>*</span></label>
                                    <input type="text" class="form-control yourphone" name="phone" value="" placeholder="{{$lang->doph}} " required="">
                                </div>
                                <div class="form-group">
                                    <label for="shippingFull_name">{{$lang->doeml}}  <span>*</span></label>
                            ...
                            <div class="form-group"  style="display:none">
                                ...
                                <div class="form-group">
                                    <label for="shippingFull_name">{{$lang->suph}}  <span>*</span></label>
                                    <input type="text" id="numberField" class="form-control" name="zip" value="" placeholder="Postal Code" required="">
                                </div>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12" {!!$shipping_cost == 0 ? 'style="margin-top:39px;"' : ''!!}>
                                    ...
                                    <div class="shipping-details-area" style="display: none;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control yourphone" type="number" name="shipping_email" id="shipingPhone_number" placeholder="{{$lang->doph}} ">
                                        </div>
                                        <div class="form-group">
