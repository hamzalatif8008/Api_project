...
<div>
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane fade" id="digital">
                                        <form class="form-horizontal" action="{{route('admin-prod-store1')}}" method="POST" enctype="multipart/form-data"  id="form2">
      ...
      <div class="tab-pane fade" id="license">
                                        <form class="form-horizontal" action="{{route('admin-prod-store2')}}" method="POST" enctype="multipart/form-data"  id="form3">
                          ...
                          <br>
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="blood_group_display_name">Platform * <span>(Optional)</span></label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" name="platform" id="blood_group_display_name" placeholder="Enter Platform" type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="blood_group_display_name">Region * <span>(Optional)</span></label>
                                                <div class="col-sm-6">
                                                    <input class="form-control" name="region" id="blood_group_display_name" placeholder="Enter Region" type="text" >
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="control-label col-sm-4" for="blood_group_display_name">Type * <span>(Optional)</span></label>
                                                <div class="col-sm-6">
