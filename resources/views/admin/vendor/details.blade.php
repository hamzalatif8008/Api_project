                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td width="49%" style="text-align: right;"><strong>Frenchise</strong></td>
                                    <td>                                                        <span class="dropdown">
                                    <button class="btn btn-{{$user->frenchise_id ==null ? "danger" : "success"}} product-btn dropdown-toggle btn-xs" type="button" data-toggle="dropdown" style="font-size: 14px;">{{$user->frenchise_id > 0  ? $user->frenchise->frenchise_name."---" .$user->frenchise->frenchise_address : "Please Asign Franchise"}}
                                        <span class="caret"></span></button>
                                        <ul class="dropdown-menu">
                                            @foreach($frenchise as $key)
                                            <li><a href="{{route('admin-frenchise-asign',['id'=>$user->id,'id2'=>$key->id])}}">{{$key->frenchise_name."---".$key->city."---".$key->frenchise_address}}</a></li>
                                            @endforeach
                                        </ul>
                                        </span>
                                        </td>
                            ...
                            @if($user->province != "")
                            <tr>
                                <td width="49%" style="text-align: right;"><strong>Province:</strong></td>
                                <td>{{$user->province}}</td>
                            </tr>
                            @endif
                            @if($user->city != "")
