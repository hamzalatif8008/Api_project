...
class FrenchiseOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $orders = Vendororder::whereIn('user_id',$auth)->orderBy('id','desc')->get();
    ...
    public function ordersstatus($status)
    {
        ...
        $vendor = $user->vendors()->get()->pluck('id'); 
        $orders = Vendororder::whereIn('user_id',$vendor)->where('status','=',$status)->orderBy('id','desc')->get();
