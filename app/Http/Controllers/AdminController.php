...
class AdminController extends Controller
{
    ...
    public function status($id1,$id2)
    {
        ...
        $frenchise->update();
        Session::flash('success', 'Frenchise Status Upated Successfully.');
        return redirect()->back();
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin-frenchise-index')->with('success','Frenchise Information Updated Successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('admin-frenchise-index')->with('success','Frenchise Delete Successfully.');;
    }
...
$conv = AdminUserConversation::where('user_id','=',$user->id)->where('subject','=',$subject)->first();
 ...
 public function frenchiseAsign($uid ,$fid)
 {
       ...
       Session::flash('success', 'Frenchise Asign  successfully.');
       return redirect()->back();
 }
