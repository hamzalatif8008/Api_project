...
class FrontendController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // $cities = Country::get()->pluck('city');
        // $fcities = Frenchise::whereIn('city',$cities)->groupBy('city')->get()->pluck('city');
        

        return view('front.index',compact('fcategory','category','top_shop','nav_shop','ads','sls','sliders','brands','banner','fproducts','beproducts','tproducts','hproducts','lproducts','biproducts','imgs','services'));
    }
...
// exit;
    ...
    { 
        ...
        return view('front.country',compact('cat','cats','sort','min','max','c_banner','slug'));
        } 
        return view('front.country',compact('cat','sort','cats','c_banner','slug')); 
    }
    ...
    public function frenchisevendorlist(Request $request,$id)
    {
        ...
        // dd($fcitiesd);
        return view('front.frenchisealllist',compact('frenvendor'));
    }
    ...
    public function category(Request $request,$slug)
    {
        ...
        return view('front.category',compact('cat','cats','sort','min','max','c_banner'));
        }
        return view('front.category',compact('cat','sort','cats','c_banner'));
    }
    ...
    // public function allproduct(Request $request, $ptype)
    // {
    //     $banner   = Banner::findOrFail(1);
    //     $sort = "";
    //     $cat = Category::first();
    ...
    //     $max = $request->max;
    //     $cats = $cat->products()->where('status','=',1)->whereBetween('cprice', [$min, $max])->orderBy('cprice','asc')->paginate(9);
    //     return view('front.dealsofday',compact('ptype','cat','cats','sort','min','max','banner'));
    //     }
    //     return view('front.dealsofday',compact('ptype','cat','sort','cats','banner'));
    // }

    // public function allproductsort($ptype,$sorted)
    // {
    //     $banner   = Banner::findOrFail(1);
    //     $sort = $sorted;
    //     $cat = Category::first();
    ...
    //     if($sort == "new")
    //     {
    //     $cats =  Product::where($ptype,'=','1')->orderBy('id','desc')->paginate(9);
    //     }
    //     else if($sort == "old")
    //     {
    //     $cats =  Product::where($ptype,'=','1')->paginate(9);
    //     }
    //     else if($sort == "low")
    //     {
    //     $cats =  Product::where($ptype,'=','1')->orderBy('cprice','asc')->paginate(9);
    //     }
    //     else if($sort == "high")
    //     {
    //     $cats =  Product::where($ptype,'=','1')->orderBy('cprice','desc')->paginate(9);
    //     }
    //     return view('front.dealsofday',compact('cat','cats','sort','ptype','banner'));
    // }
    ...
    public function festival(Request $request,$ptype)
    {
        ...
        $max = $request->max;
        $cats = $cat->products()->where('status','=',1)->whereBetween('cprice', [$min, $max])->orderBy('cprice','asc')->paginate(9);
        return view('front.dealsofday',compact('cat','cats','sort','min','max','ptype','f_banners'));
        }
        return view('front.dealsofday',compact('cat','sort','cats','ptype','f_banners'));
    }
...
public function blogshow($id)
    ...
    public function contactemail(Request $request)
    {
        ...
        // $value = $request->session()->get('captcha_string');
    ...
    //     return response()->json(['captcha'=> $this->code_image()]);
    //     // return "done";
    // }
    ...
    public function shoptype($slug) 
    {
        ...
        return view('front.allshops',compact('topshops','slug')); 
    }
    ...
    public function productsearch(Request $request)
    {
        ...
        ->orWhere('status','=',1)->orWhere('name', 'like', '%' . $name . '%')->whereBetween('cprice', [$min,$max])->get();
         return view('front.advancesearch' , compact('products'));
        // }
        // else{
        // return view('front.advancesearch' );
        // }
    ...
    public function shopsearch(Request $request)
    {
        ...
        return view('front.advancesearch' , compact('shops'));
    }

    public function brandsearch(Request $request)
    {
        // $brands = User::where(function ($request) {
        //     $request->where('brand','=','1');
        // })->where(function ($request) {
        //     $request->where('brand', 'like', "%{$request->brand}%")->get();
        // });
        $brands = User::where('shop_name', 'like', '%' . $request->shop_name . '%')->Where('brand','=','1')->get();
        return view('front.advancesearch' , compact('brands'));
    ...
    public function frenchisesearch(Request $request)
    {
        ...
        // dd($frenchises);
        return view('front.advancesearch' , compact('frenchises'));
       
    }
    
 public function paymentpage($id){ 
    $order = Order::find($id);
    return view('front.paymentpage',compact('order'));
}
